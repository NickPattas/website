...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/usr/local/share/npm-global/lib/node_modules/\@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH=/home/node/.vscode-server/data/User/globalStorage/github.copilot-chat/debugCommand\:/home/node/.vscode-server/data/User/globalStorage/github.copilot-chat/copilotCli\:/vscode/vscode-server/bin/linux-x64/bf9252a2fb45be6893dd8870c0bf37e2e1766d61/bin/remote-cli\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/local/share/npm-global/bin
